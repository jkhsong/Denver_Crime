...
where <img src="readme_images/eqn1.1.png" height=20px />represents the nonperiodic trend, <img src="readme_images/eqn1.2.png" height=20px />represents the periodic (seasonal) component, and <img src="readme_images/eqn1.3.png" height=15px>represents a normally distributed error term.  Seasonality may occur daily, weekly, monthly, and/or yearly.  Other seasonalities and events such as holidays are accommodated may be accounted for by Prophet as well.<br><br>
